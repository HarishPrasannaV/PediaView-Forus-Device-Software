...
def display_images():
    if os.path.exists('captured') and os.path.isdir('captured'):
        subdirs = sorted(
            glob.glob('captured/*'),
        ...
        if subdirs:
            ...
            if image_files:
                ...
                display_message("No images found in 'captured' subfolders.")
        else:
            display_message("No subdirectories found in 'captured' folder.")
    else:
        display_message("No 'captured' folder found.")
